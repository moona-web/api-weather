...
const showWeatherComponent = (data) => {
    ...
    <div class="details">
        <img alt="icon" src="http://api.openweathermap.org/img/w/${data.list[0].weather[0].icon
        }.png" />
    ...
    <div class="info">
        ...
        <p><span><i class="bi bi-wind"></i></span> ${data.list[0].wind.speed
        } km/h</p>
    </div>
...
const createWeatherContainerComponent = (item) => {
    weatherContainer.innerHTML += `
<div>
<img alt="icon" src="http://api.openweathermap.org/img/w/${item.weather[0].icon
        }.png" />
